...
CREATE TABLE `products` (
  ...
  CONSTRAINT `FK_id_color` FOREIGN KEY (`fk_color`) REFERENCES `colors` (`id_color`),
  CONSTRAINT `FK_id_genre` FOREIGN KEY (`fk_genre`) REFERENCES `genres` (`id_genre`),
  CONSTRAINT `FK_id_trademark` FOREIGN KEY (`fk_trademark`) REFERENCES `trademarks` (`id_trademark`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-11-28 11:52:44
